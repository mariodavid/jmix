...
public interface EntityImportViewBuilderAPI {
     ...
     * <p>
     * All references will be added to the view as a {@link io.jmix.core.app.importexport.ReferenceImportBehaviour#ERROR_ON_MISSING}
     * behavior. All references that have a @Composition annotation will be added to the view with a property that has a
     * {@link io.jmix.core.app.importexport.EntityImportViewProperty}. This means that compositions will be
