...
public interface EntityImportExportService {
     ...
     * io.jmix.core.app.serialization.EntitySerializationAPI#toJson(Collection)
    ...
    /**
     * <p>Serializes a collection of entities to JSON using {@link io.jmix.core.app.serialization.EntitySerializationAPI
     * EntitySerializationAPI}.</p> <p>Serialization is described in the {@link io.jmix.core.app.serialization.EntitySerializationAPI#toJson(Collection)
     * EntitySerializationAPI#toJson(Collection)} method documentation</p>
     *
     * @param entities a collection of entities to export
     ...
     * parameter.</p> <p>Serialization is described in the {@link io.jmix.core.app.serialization.EntitySerializationAPI#toJson(Collection)
     * EntitySerializationAPI#toJson(Collection)} method documentation</p>
     *
     * @param entities a collection of entities to export
     * @param view     before serialization to JSON entities will be reloaded with this view
